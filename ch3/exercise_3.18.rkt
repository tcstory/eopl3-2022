...
(define (let*-exp-handler vars exps body value-of env)
  (if (null? vars)
      (value-of body env)
...
(define (unpack-exp-handler vars exp1 body value-of env)
...
(define (value-of exp env)
  (cases expression exp
         ...
         (let*-exp (vars exps body)
                   (let*-exp-handler vars exps body value-of env))
         (minus-exp (exp1)
         ...
         (unpack-exp (vars exp1 body) (unpack-exp-handler vars exp1 body value-of env))
